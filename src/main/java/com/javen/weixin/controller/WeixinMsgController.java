...
import com.yeqin.weather.WeatherReportByCity;
	...
	protected void processInTextMsg(InTextMsg inTextMsg){
		...
		if ("help".equalsIgnoreCase(msgContent) || "帮助".equals(msgContent)) {
			...
			ApiResult result = TemplateMsgApi.send(json);
			 ...
			 renderNull();
		}else if (!WeatherReportByCity.GetTodayTemperatureByCity(msgContent).equals("202")) {
			
			renderOutTextMsg(WeatherReportByCity.GetTodayTemperatureByCity(msgContent));
